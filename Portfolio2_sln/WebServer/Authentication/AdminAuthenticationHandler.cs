...
{
    public class AdminAuthenticatedHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        public AdminAuthenticatedHandler(
        ...
        protected override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var authenticatedUser = new AuthenticatedUser("AdminAuthentication", true, "password");
